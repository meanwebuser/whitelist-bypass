...
2. По желанию измените: имя в звонке, порт SOCKS5, логин/пароль SOCKS5, режим туннеля (**Video** или **DataChannel** - доступен только для WB Stream и VK), VP8 FPS / batch, DNS для адаптера
